...
$config['view']['name']        = 'Storage';                   // название сайта
$config['view']['description'] = 'Storage for BMSTU'; // seo description
 ...
 * Общие настройки
 */
$config['general']['admin_mail']  = 'support@iu8-praktika.ru'; // email администратора
...
$config['db']['table']['stor'] = '___db.table.prefix___stor';
$config['db']['table']['testconnect'] = '___db.table.prefix___testconnect';
...
$config['router']['page']['storage']       = 'ActionStorage';
$config['router']['page']['ajax']          = 'ActionAjax';
$config['router']['page']['auth']		   = 'ActionAuth';
$config['router']['page']['upload']		   = 'ActionUpload';
